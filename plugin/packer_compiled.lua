...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/Users/Macbook/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/Users/Macbook/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
  ...
  ["nvim-treesitter"] = {
    ...
    url = "https://github.com/ulmas97/nvim-treesitter"
  },
  ["nvim-web-devicons"] = {
    loaded = true,
  ...
  ["popup.nvim"] = {
    loaded = true,
    path = "/Users/Macbook/.local/share/nvim/site/pack/packer/start/popup.nvim",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/Users/Macbook/.local/share/nvim/site/pack/packer/start/vim-bbye",
